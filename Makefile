...
get_ecr_login:
	aws ecr get-login-password --region us-west-1 | docker login --username AWS --password-stdin 474668428902.dkr.ecr.us-west-1.amazonaws.com

# Tag image for ECR:
tag_image:
	docker tag genai-bot 474668428902.dkr.ecr.us-west-1.amazonaws.com/genai-bot

# Push the image to ECR
push_to_ecr:
	docker push 474668428902.dkr.ecr.us-west-1.amazonaws.com/genai-bot
